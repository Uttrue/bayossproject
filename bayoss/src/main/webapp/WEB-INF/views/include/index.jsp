<!-- 중단 배너 시작-->
    <!-- <div class="hero-wrap" style="background-image: url('/resources/images/cruiseship2.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-11 ftco-animate text-center">
			<br><br><br><br><br><h1 class="mb-4">BAY OF Smart Service</h1>
					<h5 class="mainh5">Feel as if you are at home and tell us anything
						needed for your safe journey at the next sea.
						Like Service Area on the Highways, BAYOSS is there in every harbor cities.</h5><br><br>
            <p><a href="/user/aboutus" class="btn btn-primary mr-md-4 py-3 px-4"  >Learn more </a></p><br><br><br><br><br><br><br><br>
          </div>
        </div>
      </div>
    </div> -->
			...
			<div>
				<div class="col-md-11 ftco-animate text-center">
					...
					<h5 class="mainh5">Feel as if you are at home and tell us
						...
						cities.</h5>
					<p>
						<a href="/user/aboutus" class="btn btn-primary mr-md-4 py-3 px-4">Learn
							more </a>
					</p>
					<br><br>
				</div>
    	...
    	<div class="container">
          ...
          <div class="col-md-3 d-flex align-self-stretch px-4 ftco-animate">
            <div class="d-block services text-center">
              ...
              <div class="media-body">
                <h3 class="heading">Supplies</h3>
                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right.</p>
                <a href="supplies.html" class="btn-custom d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span><i class="sr-only">Read more</i></a>
              </div>
            </div>    
          </div>
          <div class="col-md-3 d-flex align-self-stretch px-4 ftco-animate">
		  ...
		  <div class="col-md-3 d-flex align-self-stretch px-4 ftco-animate">
            <div class="d-block services text-center">
              ...
              <div class="media-body">
                ...
                <p>Ship Maintenance service
					Next-generation data provides exceptional flexibility and scalability.</p>
                <a href="shopping.html" class="btn-custom d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span><i class="sr-only">Read more</i></a>
              </div>
            </div>      
          </div>  
        </div>
        ...
        <div class="row d-flex">
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="#" class="block-20 rounded" style="background-image: url('/resources/images/md1.jpg');">
              </a>
              <div class="text p-4">
              	<div class="meta mb-2">
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20 rounded" style="background-image: url('/resources/images/md2.jpg');">
              </a>
              <div class="text p-4">
              	<div class="meta mb-2">
                  <div><a href="#">April 07, 2020</a></div>
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20 rounded" style="background-image: url('/resources/images/md3.jpg');">
              </a>
              <div class="text p-4">
              	<div class="meta mb-2">
                  <div><a href="#">April 07, 2020</a></div>
...
<!-- 중단 클라이언트 피드백 시작-->
    <section class="ftco-section testimony-section" style="background-image: url('/resources/images/cruiseship2.jpg');">
    	<div class="overlay"></div>
      <div class="container">
        <div class="row justify-content-center pb-5 mb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
                ...
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(/resources/images/merchantship.jpg)"></div>
                    	<div class="pl-3">
...
<!-- 중단 배너 아래 Why Choose Us?시작-->
    <section class="ftco-section ftco-no-pt ftco-no-pb">
    	<div class="container">
    		<div class="row d-flex no-gutters">
    			<div class="col-md-5 d-flex">
    				<div class="img img-video d-flex align-self-stretch align-items-center justify-content-center justify-content-md-center mb-4 mb-sm-0" style="background-image:url(/resources/images/SEA.jpg);">
    				</div>
    			</div>
	            ...
	            <h2 class="mb-4">Why Choose Us?</h2>
    				...
    				<div class="row">
	    				<div class="col-md-6 services-2 w-100 d-flex">
	    					<div class="icon d-flex align-items-center justify-content-center"><h3 style="color: white;">1</h3></div>
	    					<div class="text pl-3">
	    						<h4>Fast</h4>
	    				...
	    				<div class="col-md-6 services-2 w-100 d-flex">
	    					<div class="icon d-flex align-items-center justify-content-center"><h3 style="color: white;">2</h3></div>
	    					<div class="text pl-3">
	    						<h4>Quality</h4>
	    						<p>Far far away, behind the word mountains, far from the countries.</p>
	    					</div>
	    				...
	    				<div class="col-md-6 services-2 w-100 d-flex">
	    					<div class="icon d-flex align-items-center justify-content-center"><h3 style="color: white;">3</h3></div>
	    					<div class="text pl-3">
	    						<h4>Services</h4>
	    						<p>Far far away, behind the word mountains, far from the countries.</p>
	    					</div>
	    				...
	    				<div class="col-md-6 services-2 w-100 d-flex">
	    					<div class="icon d-flex align-items-center justify-content-center"><h3 style="color: white;">4</h3></div>
	    					<div class="text pl-3">
	    						<h4>Help</h4>
	    						<p>Far far away, behind the word mountains, far from the countries.</p>
	    					</div>
    	...
    	<div class="container">
          ...
          <div class="col-md-6 col-lg-3 d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18 text-center">
              ...
              <div class="text">
              	<span>shop waiting to enter</span>
              </div>
            </div>
          </div>
        </div>
    		...
    		<div class="row">
    			<div class="col-lg-6 order-md-last">
    				...
    				<div class="d-flex mt-3">
    					<div class="img img-2 mr-md-2" style="background-image:url(/resources/images/cruiseship.jpg);"></div>
    					<div class="img img-2 ml-md-2" style="background-image:url(/resources/images/cruiseship3.jpg);"></div>
    				</div>
    			</div>

    			<div class="col-lg-6">
    				<div class="heading-section mb-5 mt-5 mt-lg-0">
	            <h2 class="mb-3">provide services</h2>
...
<!-- 하단 입점문의 시작-->
    <!-- <section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb img" style="background-image: url(/resources/images/cruiseship2.jpg);">
			<div class="overlay"></div>
    	<div class="container">
    		<div class="row d-md-flex justify-content-end">
    			<div class="col-md-12 col-lg-6 half p-3 py-5 pl-lg-5 ftco-animate">
    				<h2 class="mb-4">enter shop consultation</h2>
    				<form action="#" class="appointment">
    					<div class="row">
	                      ...
	                      <select name="" id="" class="form-control">
	                        ...
	                        <option value="">supplies Services</option>
	                        <option value="">Service</option>
	                        <option value="">shopping Service</option>
	                      </select>
	                    </div>
			              </div>
			    				</div>
